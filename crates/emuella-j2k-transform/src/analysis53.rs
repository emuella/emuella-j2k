...
//! extension occurs at a panel boundary. See `docs/forward53-panels.md` in the
...
impl Forward53Plan {
    ...
    pub fn new(
        ...
        let backend = if backend == Forward53Backend::RowPanelParallel && slots == 1 {
            Forward53Backend::RowPanelScalar
        } else {
            backend
        };
