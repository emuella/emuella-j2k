...
pub struct LosslessExecutionDiagnostic {
    ...
    pub forward53_panel_prepare_attempts: usize,
    pub forward53_panel_initialised_bytes: usize,
    pub forward53_original_helper_calls: usize,
    pub forward53_original_scratch_capacity_bytes: usize,
